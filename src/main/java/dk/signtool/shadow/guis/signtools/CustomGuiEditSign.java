...
import dk.signtool.shadow.utils.SignBuffer;
...
public class CustomGuiEditSign extends GuiScreen
{
    ...
    private List<GuiButton> signToolsGuiButtons = new ArrayList<GuiButton>();

    public CustomGuiEditSign(TileEntitySign teSign, Signtool addon)
    {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        System.out.println("key trykked" + keyCode);
        if (keyCode == 1)
        {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(addon.isSignToolsGuiOpen && this.signToolsGuiRenderOffset == -5){
            ...
            TaDrawUtils drawUtils = Signtool.getDrawUtils();
